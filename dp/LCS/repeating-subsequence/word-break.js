...
const main = function () {
  ...
  //   "leet", "code", "neet"
  // ]
  const s = ['leetcode', 'neetcode', 'neetcodes', 'vegancookbook', 'catsanddog', 'highwaycrash',
    'screamicecream', 'educativecourse']
  const wordDict = ['leet', 'code', 'neet', 'v', 'vegan', 'cookbook', 'vegancookbook', 'veg', 'gan', 'eg', 'eganc', 'ookboo',

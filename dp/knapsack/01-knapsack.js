...
function main () {
  const weights = [[1, 2, 3, 5], [4], [2], [3, 6, 10, 7, 2], [3, 6, 10, 7, 2, 12, 15, 10, 13, 20]]
  const values = [[1, 5, 4, 8], [2], [3], [12, 10, 15, 17, 13], [12, 10, 15, 17, 13, 12, 30, 15, 18, 20]]
  const capacity = [6, 3, 3, 10, 20]
  const n = [4, 1, 1, 5, 10]
  ...
  for (let i = 0; i < values.length; ++i) {
    ...
    const result = findKnapsack(capacity[i], weights[i], values[i], n[i])
    const result1 = findKnapsack1D(capacity[i], weights[i], values[i], n[i])
    const result2 = findKnapsackRec(capacity[i], weights[i], values[i], n[i])

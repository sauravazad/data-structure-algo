...
// brute force
var largestRectangleAreaB = function(heights) {
  let maxArea = 0
  ...
  for(let i = 0 ; i < heights.length; i++) {
    ...
    for(let width = i ; width < heights.length; width++) {
        ...
        let breadth = width - i + 1  // ( current pointer for width  - element pointer  + 1)
      let area = minHeight * (breadth) // height * breadth
...
var main = function () {
  ...
  for (var i = 0; i < input.length; i++) {
      ...
      var result = largestAreaHistogram(input[i]);

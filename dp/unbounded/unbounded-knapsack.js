...
// Driver code
function main() {
	let weights = [[1, 2], [2, 4, 6], [1, 2, 3, 5], [4], [2], [3, 6, 10, 7, 2], [3, 6, 10, 7, 2, 12, 15, 10, 13, 20]];
	let values = [[10, 20], [5, 11, 13], [1, 5, 4, 8], [2], [3], [12, 10, 15, 17, 13], [12, 10, 15, 17, 13, 12, 30, 15, 18, 20]];
	let capacity = [5, 10, 6, 3, 3, 10, 20];
	let n = [2, 3, 4, 1, 1, 5, 10];
	...
	for (var i = 0; i < n.length; ++i) {
		...
		let result = unboundedKnapsack(weights[i], values[i], n[i], capacity[i]);

...
2. [Final Prices With Special Discount](https://leetcode.com/problems/final-prices-with-a-special-discount-in-a-shop/)
3. [Crawler Log Folder](https://leetcode.com/problems/crawler-log-folder/)
...
4. [Maximum Score of Good Subarray](https://leetcode.com/problems/maximum-score-of-a-good-subarray/)
...
3. **Monotonic Queue** is perfect for sliding window problems
4. **Time Complexity:** Almost always O(n) for processing n elements
5. **Space Complexity:** O(n) in worst case
